	...
	return (
		<div className={"note " + (editable === 'true' ? 'isEditable' : "")}>
			...
			<div className="note__body">
				{note.title ? (<h2 className="note__title" contenteditable={editable} onInput={(e) => setTitle(e.target.innerHTML)}>{title}</h2>) : (<h2 className="note__title addtitle" contenteditable={editable}>Add a title</h2>) }
				<p ref={pInput} className="note__content" contenteditable={editable} onInput={(e) => setContent(e.target.innerHTML)}>{content}</p>
